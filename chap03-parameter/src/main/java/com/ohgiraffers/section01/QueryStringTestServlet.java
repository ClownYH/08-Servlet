...
public class QueryStringTestServlet extends HttpServlet {
    ...
    * ============================================================================================
    * Service로부터 전달받은 httpServletRequest는 요청 시 전달한 값을 getParameter() Method로 추출할 수 있다.
    * 이 때 인자로 input 태그에 지정된 name 속성의 값을 문자열 형태로 전달해주면 된다.
    * 화면에서 전달한 form 내의 모든 input 태그의 값들을 hashMap으로 관리하고 있으므로,
    * 원하는 갓을 찾기 위해서는 key 역할을 하는 문자열이 필요하기 때문이다.
    * */
    @Override
