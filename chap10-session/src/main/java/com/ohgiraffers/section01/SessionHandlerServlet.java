...
public class SessionHandlerServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        * */
        ...
        /*
        * 세션은 redirect를 해도 값을 유지할 수 있기 때문에(브라우저에 저장됨) request보다 더 넓은 범위의 공유 영역을 갖는다.
        * 세션의 값을 담을 떄 setAttribute(key, value) 형태로 담을 수 있고 값을 꺼낼 때는 getAttribute(key)로 꺼낸다.
        * */
        session.setAttribute("firstName", firstName); // cookie와 달리 세션에 정보를 저장한다.
