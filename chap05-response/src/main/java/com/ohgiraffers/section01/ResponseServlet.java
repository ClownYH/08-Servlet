...
public class ResponseServlet extends HttpServlet {
    ...
    * */
    ...
    /*
    * 사용자가 브라우저에 응답하기 위해서는 HttpServletResponse의 getWriter() method로 printWriter 인스턴스를 반환한다.
    ...
    * */
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        // 브라우저로 내보낼 데이터 타입을 응답 헤더에 설정해주지 않으면 기본값은 null이고 이는 text/plain로 인식된다.
        System.out.println("default response type : " +resp.getContentType());

        /*
        * 기본값은 text/html이지만 html 태그로 사용하면 요청 시 text/html도 응답으로 수락 가능하도록 헤더 설정이 되어 있어
        * 자동으로 text/html로 인식하게 된다. 하지만 명시적으로 text/plain로 설정하게 되면 태그를 태그로 인식하지 않고 문자열로 인식한다.
        * */
