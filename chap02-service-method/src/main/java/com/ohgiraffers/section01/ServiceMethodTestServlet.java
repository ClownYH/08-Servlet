...
public class ServiceMethodTestServlet extends HttpServlet {
    ...
    public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
        ...
        * 따라서 ServletRequest라는 추상화된 타입으로 사용하고, 실제 인스턴스는 httpSevletRequest로 사용하여
        * 나중에 Service method의 인자 타입은 변경하지 않고 다른 프로토콜을 사용하는 request로 변경이 가능하다.(다형성)
        * ===============================================================================================
        * 하지만 현재 사용되는 프로토콜은 http프로토콜로, httpServletRequest 타입이다.
        * httpServletRequest는 ServletRequest 타입을 상속받아서 구현하였으며, http 프로토콜의 정보를 담고 있기 때문에
        * 실제 사용시에는 httpServletRequest 타입으로 다운 캐스팅해서 사용해야 한다.
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("get 요청을 처리할 메소드");
    }

    @Override
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        System.out.println("post 요청을 처리할 메소드");
    }
